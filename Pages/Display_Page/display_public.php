...
//ftp_display file
if(!$_GET["cfd2"] && !$_SESSION["cfd2"])
	{
	    $_SESSION["cfd2"] = "../../Public_files/";
	}
	else if(!$_GET["cfd2"])
	{
  ...
  <body>
    ...
    <div class="display_section col-xs-12 col-md-4">
	    ...
	    <div class="panel-body" id="scroll">
	        ...
	        <?php
	        	...
	        	$public = $_SESSION["cfd2"];
	        	//print "<br>pulic is: ".$public."<br>";
	        	$root_public = "../../Public_files/";
	        	
	        	if($public == $root_public){
	        		
	        		//echo "at right place";
	        	
	        		$projects = scandir($public);
	        		//print_r($projects);
	        		//under root, no files appear, check PID
	        		
	        		foreach($projects as $project_name){
	        		
	        			if($project_name != "." && $project_name != ".." && is_dir($public.$project_name)){
						...
						//echo "<br>flag:".($flag == 1)."||project_name:".$project_name."<br>";
						...
						if($flag == 1){
							...
							echo '<div class="img">';
				 			...
				 			echo '<a href="?cfd2='.$public.$project_name.'"><img src="../../Image/Steel Closed.ico" alt="Closed File" style="width:60px;height:60px;display:block;margin-left:auto;margin-right:auto"><div class="overflow desc">'.$project_name.'</div></a>';
	        		...
	        		//echo "at wrong place ".$public."<br>";
	        		echo '<div class="img">';
				
				echo '<a href="?cfd2='.$root_public.'">';
				echo '<img src="../../Image/Steel Open.ico" alt="Open File" style="width:60px;height:60px;display:block;margin-left:auto;margin-right:auto"><div class="overflow desc"> Public Folder (Current Directory)</div>';
				echo "</a>";
					
				echo '</div>';
	        	
	        		$flag = 0;
	        		//under project, no folders appear
	        		$folder = str_replace($root_public, "", $public);
				...
				if(!$ProjectID){
       			...
       			//echo "<br>wrong place<br>";
	        			...
	        			foreach($files as $f){
	        			    ...
	        			    if($f != "." && $f != ".." && !is_dir($public.$f) ){
	        			    //echo "<br>".$f."<br>";
	        			
        				    echo '<div class="img">';
        				    
			    			echo '<form action="../Display_Page/display_public.php?cfd2='.($public).'" method="post">';
			    	
			    			echo '<button type="submit" name="file_path" value="'.$public.'/'.$f.'" style="background:transparent;border:none">';
			    	
			    			echo '<img src="../../Image/File.ico" alt="File" style="width:60px;height:60px;display:block;margin-left:auto;margin-right:auto">';
			    	
			    			echo '<div class="overflow desc" style="color:#5555FF">'.$f.'</div>';
			...
			echo '<a href="?cfd2='.($parent_filename).'">';
			...
			foreach($file_list as $file_or_dir)
			{
			    ...
			    if(!$flag){}
					...
					echo '<div class="img">';
				 		...
				 		echo '<a href="?cfd2='.$file_or_dir.'"><img src="../../Image/Steel Closed.ico" alt="Closed File" style="width:60px;height:60px;display:block;margin-left:auto;margin-right:auto"><div class="overflow desc">'.$dir_name.'</div></a>';
					...
					$dir_name = str_ireplace("/","",$dir_name);
					echo '<div class="img">';
				    			echo '<form action="../Display_Page/display_public.php?cfd2='.(ftp_pwd($ftp_conn)).'" method="post">';
	...
	<div class="display_section col-xs-12 col-md-8">
	    ...
	    <?php
	       ...
	       // print "<iframe src='../../Public_files/Project Portal/R5A0 B-VR5.html' height=500px width=800px></iframe>";
	    
	    	//print "<br>".$_POST['file_path']."<br>";
	    	$section_file_path = $_POST['file_path'];
	  	...
	  	|| $ext == "bmp"){
	  	    //display the image
	  	    print '<img src="'.$section_file_path.'" style="width:inherit;height:inherit;display:block;margin-left:auto;margin-right:auto">';
	  	}
	  	elseif($ext == "txt"
	  		|| $ext == "php"
	  		|| $ext == "js"
	  	    ...
	  	    print nl2br(file_get_contents($section_file_path));
	  	    
	  	}
	  	elseif($ext == "pdf"
	  		|| $ext == "html"){
	  		
	  	    //print "<br>".$section_file_path."<br>";
	  	    print "<iframe src='".$section_file_path."' height=500px width=800px></iframe>";
	  	    
	  		
	  	}
	  	elseif($section_file_path == ""){
	  	    print "<h2>Please select file to display. :)</h2>";
	  	}
	  	else{
	  	    print "<h2>Sorry, we can not display this file. :(</h2>";
	  	}
	    
	    //<iframe src="../../Public_files/Project Portal/R5A0 B-VR5.html" height=500px width=800px></iframe>
