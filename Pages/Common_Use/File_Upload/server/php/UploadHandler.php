...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => '../../../project/'.$_SESSION["project_upload_to"].$_SESSION["directory_upload_to"],
            'upload_url' => '../../../project/'.$_SESSION["project_upload_to"].$_SESSION["directory_upload_to"],
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
